...
export class ChatList extends BasicElement {
		...
		*/
		public getResponses(): ChatResponse[] {
		...
		public createResponse(isRobotResponse: boolean, currentTag: ITag, value: string = null): ChatResponse {
			const scrollable: HTMLElement = this.el.querySelector('scrollable') as HTMLElement
		...
		*/
		...
		private onFlowUpdate(event: CustomEvent) {
			...
			const currentTag: ITag | ITagGroup = event.detail.tag as ITag | ITagGroup
